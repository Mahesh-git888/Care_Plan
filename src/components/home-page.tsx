          ...
          <div className="grid gap-10 pb-14 pt-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:gap-16 lg:pb-20 lg:pt-14">
            <div className="max-w-3xl">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link
                  href="/elder-care"
                  className="inline-flex items-center gap-2 rounded-full bg-[#0f9aa8] px-6 py-4 text-sm font-semibold text-white shadow-[0_18px_40px_-22px_rgba(15,154,168,0.9)] transition hover:bg-[#0b7c87]"
                >
